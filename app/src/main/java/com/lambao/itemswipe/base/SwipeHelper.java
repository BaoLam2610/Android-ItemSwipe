...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton {
        ...
        // Thêm thuộc tính cho văn bản
        private String text;
        private float fontSize;
        private int fontColor;
        private String fontFamily;
        private float iconTextSpacing;

        public MyButton(Context context, int imageResId, int color, String text, float fontSize, int fontColor, String fontFamily, float iconTextSpacing, MyButtonClickListener listener) {
            this.context = context;
            this.imageResId = imageResId;
            this.color = color;
            this.text = text;  // Khởi tạo văn bản
            this.fontSize = fontSize;  // Khởi tạo kích thước font
            this.fontColor = fontColor;  // Khởi tạo màu font
            this.fontFamily = fontFamily;  // Khởi tạo font family
        ...
        public void onDraw(Canvas c, RectF rectF, int pos) {
            ...
            float iconX = (rectF.left + rectF.right) / 2 - bw / 2;
            float iconY = (rectF.top + rectF.bottom) / 2 - bh / 2 - iconTextSpacing; // Điều chỉnh khoảng cách theo chiều dọc

            c.drawBitmap(bitmap, iconX, iconY, p);

            // Vẽ chữ
            p.setColor(fontColor);  // Sử dụng màu font được truyền vào
            p.setTextSize(fontSize); // Sử dụng kích thước font được truyền vào
            ...
            float textY = iconY + bh + iconTextSpacing + textHeight / 2; // 20 là khoảng cách giữa icon và chữ
